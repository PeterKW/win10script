...
$PanelPTweaks.location = New-Object System.Drawing.Point(760, 200) #760 200 #Adjust Here
...
$pessentialtweaks.location = New-Object System.Drawing.Point(100, 0)
...
$PanelPTweaks.controls.AddRange(@($pessentialtweaks))
